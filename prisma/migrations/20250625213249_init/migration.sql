...
CREATE TABLE "AssetManagement" (
    ...
    CONSTRAINT "AssetManagement_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "AssetManagement" ADD CONSTRAINT "AssetManagement_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Revenue" ADD CONSTRAINT "Revenue_assetId_fkey" FOREIGN KEY ("assetId") REFERENCES "AssetManagement"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Cost" ADD CONSTRAINT "Cost_assetId_fkey" FOREIGN KEY ("assetId") REFERENCES "AssetManagement"("id") ON DELETE SET NULL ON UPDATE CASCADE;
